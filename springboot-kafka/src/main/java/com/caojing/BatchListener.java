...
/**
 * 批量消费 https://www.jianshu.com/p/a64defb44a23
 */
@Slf4j
@Component
...
//        return new NewTopic("topic.quick.batch", 8, (short) 1);
    ...
    @KafkaListener(groupId = "batchGroup", clientIdPrefix = "batchConsumer", containerFactory = "batchContainerFactory",
        topicPartitions = {
